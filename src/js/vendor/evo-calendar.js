...
(function(factory) {
    ...
    EvoCalendar.prototype.buildCalendar = function(val, new_month, new_year) {
        ...
        function buildCalendarHTML() {
            ...
            calendarHTML +=  '<button class="icon-button" val="prev" month-val="'+_.$active_month+'"><span class="chevron-arrow-left"></span></button>&nbsp;' +'<p>'+ monthName +'</p>' + '&nbsp;<button class="icon-button" val="next" month-val="'+_.$active_month+'"><span class="chevron-arrow-right"></span></button>';
            calendarHTML += '</th></tr>';
    ...
    EvoCalendar.prototype.selectYear = function(event) {
        ...
        $('.calendar-year p').text(_.$active_year + ' ' + $calendarTitle);
    ...
    EvoCalendar.prototype.selectMonth = function(event) {
        ...
        if($(event.currentTarget).attr("val") == "prev") {
            if( _.$active_month > 0) {
                --_.$active_month
            }
        } else if ($(event.currentTarget).attr("val") == "next") {
            if( _.$active_month < 11) {
                ++_.$active_month
            }
        } 
